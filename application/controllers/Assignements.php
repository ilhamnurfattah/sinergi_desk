...
class Assignements extends CI_Controller
{
	...
	public function index(){
		...
		$data['ticket'] = $this->ticket_model->get_assignements();

		$this->load->view('layouts/header', $data);
		$this->load->view('assignements/lists', $data);
	...
	public function response($id){
		...
		$this->load->view('layouts/header', $data);
		$this->load->view('assignements/view', $data);
		$this->load->view('layouts/footer');
	}
	...
	public function tracking_store($id_ticket){
		...
		return redirect(site_url('assignements'));
	}
